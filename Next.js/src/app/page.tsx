    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p
            className={ `m-0 max-w-[30ch] text-sm opacity-50` }>Find in-depth information about Next.js features and API.</p>
        </a>
        ...
        >
          ...
          <p
            className={ `m-0 max-w-[30ch] text-sm opacity-50` }>Learn about Next.js in an interactive course with&nbsp;quizzes!</p>
        </a>
        ...
        >
          ...
          <p
            className={ `m-0 max-w-[30ch] text-sm opacity-50` }>Instantly deploy your Next.js site to a shareable URL with Vercel.</p>
        </a>
      </div>
    </main>
  );
